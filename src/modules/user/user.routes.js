...
import UserValidationManager from "../../middleware/validation.js";
...
userRouter.get(
  "/getUserByType",
  UserValidationManager.validateGetUserByType,
  new UserController().getUserByType
);
