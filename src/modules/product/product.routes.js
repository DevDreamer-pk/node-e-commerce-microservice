...
productRouter.post(
  ...
  ProductValidationManager.validateAddProduct,
...
productRouter.post(
  "/rate-product",
  ProductValidationManager.validateRateProduct,
  new ProductController().rateProduct
);
productRouter.post(
  "/review-product",
  ProductValidationManager.validateReviewProduct,
  new ProductController().reviewProduct
);
